// app.js файл до теми Об'єкти (ДЗ в main.js)
"use strict";
...
const contacts = {
    ...
    calleCenter: {
        icon: "fas fa-phone",
        phone: "038123 345 6789",
        info() {
            return `
            <li class="mb-2"><a href="${this.phone}"> <i class="${this.icon}"></i>"> <span>${this.phone}: This number is toll free if calling from ${contacts.address.country}, otherwise we advise You to use the electronic form of communication. </span></a></li>
            `;
        }
    },
    support: {
...
console.log(contacts.calleCenter.info());
...
const product4 = new Product(4, 'Product 4 name', 41);
