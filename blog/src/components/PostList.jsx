...
const PostList = () => {
    ...
    const baseUrl = 'https://my-json-server.typicode.com/yuliachernenko/db';
    ...
    const handleClick = () => whichSort == 'likes' ? setSort('numComents') : setSort('likes'); 
